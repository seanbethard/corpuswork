...
var $author$project$Sentiment$Model = function (name) {
	return {F: name};
};
var $author$project$Sentiment$init = $author$project$Sentiment$Model('');
...
var $author$project$Sentiment$update = F2(
	function (msg, model) {
		var name = msg;
...
var $author$project$Sentiment$Name = $elm$core$Basics$identity;
...
var $author$project$Sentiment$viewInput = F4(
...
var $author$project$Sentiment$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				A4($author$project$Sentiment$viewInput, 'text', 'Sentence', model.F, $elm$core$Basics$identity)
			]));
};
var $author$project$Sentiment$main = $elm$browser$Browser$sandbox(
	{au: $author$project$Sentiment$init, aB: $author$project$Sentiment$update, aC: $author$project$Sentiment$view});
_Platform_export({'Sentiment':{'init':$author$project$Sentiment$main(
